  ...
  Lightbox.prototype.changeImage = function (imageNumber) {
    ...
    preloader.onload = function () {
      ...
      if (self.options.fitImagesInViewport) {
        ...
        // the number in blue used to be 20, I changed it to 220
        maxImageWidth =
          windowWidth -
          ...
          220;
        // the number in blue used to be 120, I changed it to 720
        maxImageHeight =
          windowHeight -
