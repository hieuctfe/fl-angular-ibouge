...
ngFileUpload.service('Upload', ['$http', '$q', '$timeout', function ($http, $q, $timeout) {
    // console.log("ngFileUpload.service");
...
(function () {
    // console.log("beginning of ngfSelect function");
    ibouge.directive('ngfSelect', ['$parse', '$timeout', '$compile',
    ...
    function linkFileSelect(scope, elem, attr, ngModel, $parse, $timeout, $compile) {
        // console.log("linkFileSelect function called");
        ...
        function changeFn(evt) {
            // console.log("changeFn function called");
            if (!isUpdating) {
                isUpdating = true;
                try {
...
//                }
        ...
        function bindAttrToFileInput(fileElem) {
            // console.log("bindAttrToFileInput function");
        ...
        function createFileInput(evt, resetOnClick) {
            // console.log("createFileInput function");
    ...
    ngFileUpload.validate = function (scope, $parse, attr, file, evt) {
        // console.log("ngFileUpload.validate function called");
    ...
    ngFileUpload.updateModel = function ($parse, $timeout, scope, ngModel, attr, fileChange,
        ...
        function update() {
            // console.log("ngFileUpload.updateModel function called");
    ...
    // console.log("end of updateModel function");

})();

(function () {
    // console.log("this function is where more directives reside");
  var validate = ngFileUpload.validate;
  var updateModel = ngFileUpload.updateModel;

  ibouge.directive('ngfDrop', ['$parse', '$timeout', '$location', function ($parse, $timeout, $location) {
    return {
      restrict: 'AEC',
      require: '?ngModel',
      link: function (scope, elem, attr, ngModel) {
        linkDrop(scope, elem, attr, ngModel, $parse, $timeout, $location);
          // console.log("ngfDrop directive");
      }
    };
  }]);

  ibouge.directive('ngfNoFileDrop', function () {
    return function (scope, elem) {
        // console.log("ngfNoFileDrop directive");
      if (dropAvailable()) elem.css('display', 'none');
    };
  });

  ibouge.directive('ngfDropAvailable', ['$parse', '$timeout', function ($parse, $timeout) {
    return function (scope, elem, attr) {
        // console.log("ngfDropAvailable directive");
      if (dropAvailable()) {
  ...
  ibouge.directive('ngfSrc', ['$parse', '$timeout', function ($parse, $timeout) {
    return {
      restrict: 'AE',
      link: function (scope, elem, attr) {
          // console.log("ngfSrc directive");
